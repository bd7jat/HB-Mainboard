...
extern void task2_UartSendReceive(void);
extern void task3_PeripheralControl(void);
extern void task4_ErrorHandle(void);
...
static void (*ptask[])()={task0_AdSample,task1_PowerControl,task2_UartSendReceive,task3_PeripheralControl,task4_ErrorHandle}; //fetch the PC of each task founction
